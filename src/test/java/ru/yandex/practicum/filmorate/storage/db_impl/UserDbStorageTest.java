...
class UserDbStorageTest {
    ...
    void removeFriend() {
        ...
        expUser1.deleteFriend(expUser2.getId());
        assertTrue(expUser1.getFiends().isEmpty());
        assertFalse(expUser2.getFiends().isEmpty());

        expUser2.deleteFriend(expUser1.getId());
        assertTrue(expUser1.getFiends().isEmpty());
        assertTrue(expUser2.getFiends().isEmpty());
    }

    private User getExpUser1() {
        User user = new User("email1@gmail.com", "Login1", LocalDate.of(1994, 11, 2));
    ...
    private User getExpUser2() {
        User user = new User("email2@gmail.com", "Login2", LocalDate.of(1995, 11, 3));
